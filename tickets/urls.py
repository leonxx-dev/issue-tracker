...
from .views import get_tickets, ticket_detail, create_or_edit_ticket, ticket_prepayment
...
urlpatterns = [
    ...
    re_path(r'^(?P<pk>\d+)/prepayment/$', ticket_prepayment, name='ticket_prepayment'),
]